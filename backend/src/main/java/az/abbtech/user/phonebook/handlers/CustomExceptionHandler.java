package az.abbtech.user.phonebook.handlers;

import az.abbtech.user.phonebook.dto.ErrorResponseDto;
import az.abbtech.user.phonebook.exceptions.AuthorizationException;
import az.abbtech.user.phonebook.exceptions.FailedToGetSuccessfulResponseException;
import az.abbtech.user.phonebook.exceptions.RecordNotFoundException;
import az.abbtech.user.phonebook.exceptions.ValidationException;
import az.abbtech.user.phonebook.logger.MainLogger;
